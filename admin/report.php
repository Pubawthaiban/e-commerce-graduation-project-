                ...
                <div class="row-fluid">
                    ...
                    <form action="report.php" method="post">
                        ...
                        <span class="add-on"><i class="icon-search"></i></span>
                           	<input type="date" name="date" class="span8" value="<?=$_POST['date'];?>"/>
					...
					if(isset($_POST['date'])){?>
                    <div align="center"><h4>สรุปยอดขายประจำวันที่ <?=$_POST['date'];?></h4></div>
                    ...
                    <?php
					$con = "con";
		$sql1 = mysql_query("select *,sum(detailnum) as num from db_order,db_orderdetail,product where db_order.status = '$con' and db_order.order_id = db_orderdetail.order_id and product.product_id = db_orderdetail.product_id and order_date = '$_POST[date]' group by product_name")or die(mysql_error());
                    ...
                    <div align="center" style="margin-top:9px"><a href="report1.php?date=<?=$_POST['date'];?>" class="btn"><i class="icon-print"></i></a></div>
                    <? } 
					?>
                    </div>
                    </div>
